...
function h_pT "Enthalpy by pressure and temperature"
input Real P;
      input Real T;
...
model Tank "Tank model"
  ...
  // Geometry
  SIunits.Height level(stateSelect=StateSelect.prefer,
  start=level_start)
      "liquid level";
  SIunits.Volume V "Tank volume";
  parameter SIunits.Height height "Height of tank";
